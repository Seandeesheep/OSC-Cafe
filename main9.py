...
class Menu:
    ...
    def __init__(self):
        # all menu items
        BEEFBURGER = MenuItem("Beef Burger", "assets/home_img.png", "14.99")
        ...
        # categorised menus
        self.fav_menu = [BEEFBURGER, MACNCHEESE, WEDGES, LATTE]
        self.main_menu = [BEEFBURGER, MACNCHEESE, HOTDOG, KATSU]
...
class CustomerGUI:
    ...
    def checkout_screen(self):
        ...
        # initialising organised order
        self.current_order = self.organise_order()
